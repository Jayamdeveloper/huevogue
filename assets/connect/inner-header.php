...
<body>
    ...
    <header class="header header-sticky header-transparent header-sticky-smart disable-transition-all position-relative start-0 end-0 z-index-5">
                ...
                <div class="container-wide container">
                    <div class="d-flex d-xl-none w-100 flex-nowrap">
                        ...
                        <div class="d-flex mx-auto">
                            <a href="index.php" class="navbar-brand has-sticky-logo px-8 py-4 mx-auto logo--align">
                                <img class="light-mode-img" src="assets/img/logo-dark.png" alt="HUE VOGUE">
                    ...
                    <div class=" d-xl-flex flex-column flex-xl-row w-100">
                        <div class="w-auto w-xl-50 d-flex align-items-center justify-content-flex-end">
                            ...
                            <ul class="navbar-nav w-100 w-xl-auto navss--mobile-hide">
                                <li class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover dropdown-fullwidth">
                                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px mr--30" href="index.php" id="menu-item-home">Home</a>
                                </li>
                                <li class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover dropdown-fullwidth position-static">
                                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px" href="index.php#about" id="menu-item-shop">New Collection</a>
                                </li>
                            </ul>
                        </div>
                        <div class="px-10  d-xl-flex align-items-center navss--mobile-hide">
                            <a href="index.php" class="navbar-brand has-sticky-logo px-0 py-4 mx-auto">
                                <img class="light-mode-img" src="assets/img/logo-dark.png" alt="HUE VOGUE">
                        ...
                        <div class="w-auto w-xl-50 d-flex align-items-center">
                            ...
                            <ul class="navbar-nav w-100 w-xl-auto navss--mobile-hide">
                                <li class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover dropdown-fullwidth">
                                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px " href="index.php#products" id="menu-item-blocks">Products</a>
                                </li>
                                <li class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover dropdown-fullwidth">
                                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px " href="index.php#contactus" id="menu-item-docs">Contact Us</a>
                                </li>
                            </ul>
                            ...
                            <div class="icons-actions d-flex justify-content-end ms-auto fs-28px text-light">
                                ...
                                <div class="dropdown dropstart pe-lg-5">
                                    <div type="button" class="" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <div class="px-5 d-xl-inline-block">
                                    <a class="lh-1 color-inherit text-decoration-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
