...
<div class="content-wrapper">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-start align-items-center mb-4">
                            <div class="avatar me-2">
                                <img src="{{ asset('demo/assets/img/avatars/1.png') }}" alt="Avatar"
                                    class="rounded-circle">
                            </div>
                            <div class="d-flex flex-column">
                                <a href="../../user/view/account.html" class="text-body text-nowrap">
    ...
    <!-- / Content -->
    <script src="{{ asset('demo/assets/js/app-ecommerce-order-details.js') }}"></script>
    <script src="{{ asset('demo/assets/js/modal-add-new-address.js') }}"></script>
    <script src="{{ asset('demo/assets/js/modal-edit-user.js') }}"></script>
    @endsection