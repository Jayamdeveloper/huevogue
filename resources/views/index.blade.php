...
<head>
    ...
    <title>{{isset($home->title)?$home->title:'' }}</title>
    <link rel="icon" href="{{ isset($home->title)? asset($home->favicon):'' }}">
                ...
                <div class="container-wide container">
                    <div class="d-flex d-xl-none w-100 flex-nowrap">
                        ...
                        <div class="d-flex mx-auto">
                            <a href="{{route('home')}}"
                                class="navbar-brand has-stic0ky-logo px-8 py-4 mx-auto logo--align">
                                <img class="light-mode-img" src="{{ asset('assets/img/logo.png') }}" alt="HUE VOGUE">

                                <img class="sticky-logo sticky-logo-light"
                                    src="{{ isset($home->logo)? asset($home->logo):'' }}" alt="HUE VOGUE">
                    ...
                    <div class="d-xl-flex flex-column flex-xl-row w-100">
                            ...
                            <ul class="navbar-nav w-100 w-xl-auto navss--mobile-hide">
                                ...
                                <li
                                    ...
                                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px"
                                        href="#about" id="menu-item-shop">New Collection</a>
                        ...
                        <div class="px-10  d-xl-flex align-items-center navss--mobile-hide">
                            <a href="{{route('home')}}"
                                class="navbar-brand has-sticky-logo px-0 py-4 mx-auto logo--align">
                                <img class="light-mode-img" src="{{ asset('assets/img/logo.png') }}" alt="HUE VOGUE">
                        ...
                        <div class="w-auto w-xl-50 d-flex align-items-center">
                            ...
                            <ul class="navbar-nav w-100 w-xl-auto navss--mobile-hide">
                                <li
                                    class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover dropdown-fullwidth <?php echo strpos($current_uri, 'products') !== false ? 'active' : ''; ?>">
                                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px"
                                        href="#products" id="menu-item-blocks">Products</a>
                                </li>
                                <li
                                    class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover dropdown-fullwidth <?php echo strpos($current_uri, 'contactus') !== false ? 'active' : ''; ?>">
                                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px"
                                        href="#contactus" id="menu-item-docs">Contact Us</a>
                                </li>
                            </ul>
                            ...
                            <div class="icons-actions d-flex justify-content-end ms-auto fs-28px text-light">
                                ...
                                <div class="dropdown dropstart pe-lg-5">
                                    <div type="button" class="cart-icon" type="button" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        @if(session('user_image'))
                                        <img height="25" width="25" style="border-radius: 50px;"
                                            src="{{(session('user_image'))?session('user_image'):''}}">
                                        @else
                                ...
                                <div class="px-5 d-xl-inline-block">
                                    <a class="lh-1 color-inherit text-decoration-none cart-icon" type="button"
            ...
            <div class="hero hero-header-13 container-fluid">
                <div class="row">
                    ...
                    <div data-animate="fadeInUp" class="col-6 mb-md-0 px-0">
                        <div
                            class="d-flex justify-content-center border-0 text-center hero-hover-shine hover-zoom-in hero-height">
                            ...
                            <img class="lazy-image dark-mode-img object-fit-cover w-100 object-fit-cover img-fluid"
                                src="#" data-src="{{ isset($val->image) ? asset($val->image):'' }}" width="570"
                                height="700" alt="BODYCARE">
                            <div
                                class="card-img-overlay d-inline-flex flex-column p-8 justify-content-center hero-overlay-2">
                    ...
                    <!-- <div data-animate="fadeInUp" class=" col-6 mb-md-0 px-0">
                        <div
                            class="d-flex justify-content-center border-0 text-center hero-hover-shine hover-zoom-in hero-height">
                            <img class="lazy-image object-fit-cover w-100 object-fit-cover img-fluid" src="#"
                                data-src="{{ asset('assets/img/slider/right-slide.jpg') }}" width="570" height="700"
                                alt="SKINCARE">
                            <div
                                class="card-img-overlay d-inline-flex flex-column p-8 justify-content-center hero-overlay-2">
                ...
                <div class="row pb-12">
                    ...
                    <div class="col-12">
                        <div class="collection-con position-relative">
                            <img src="{{ isset($collection->image) ? asset($collection->image):'' }}" alt="">
                ...
                <div class="col-sm-6 d-flex justify-content-center">
                    <div class="product--con">
                        ...
                        <div class="product--des">
                            {{ isset($pro->productName)?$pro->productName:'' }}
                        </div>

                        <div class="product-description">
                            @if($pro->productDescription)
                            {!! html_entity_decode($pro->productDescription) !!}
                            @endif
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 contact-con-form">
                        <h2 class="mb-11 fs-3">{{isset($home->contenTitle)?$home->contenTitle:''}}</h2>
                        <form method="post" class="contact-from" id="contactForm" autocomplete="off"
                            onsubmit="return checkCaptcha()">
                            <div class="row">
                                <div class="form-group col-lg-6 col-xl-6 col-sm-12 col-xs-12 col-md-6 mb--20">
                                    <input type="text" name="name" value="" id="fullName" class="form-control"
                                        placeholder="Full Name*" onkeypress="validateInput(event)"
                                ...
                                <div class="form-group col-lg-6 col-xl-6 col-sm-12 col-xs-12 col-md-6 mb--20">
                                    <input type="email" id="email" name="email" class="form-control" value=""
                                        ...
                                        oninput="clearError('gmail-error'); emailValidation(this, event);">

                                    <div id="gmail-error" class="ms-1 mt-2" style="color:red; font-weight: 500;"
                                        title="Please enter a valid email address (e.g., user@example.com)."></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" name="phone" class="form-control mb--20"
                                    placeholder="Enter Your Phone Number *" value="" maxlength="10"
                                    oninput="validatePhoneNumber(this); clearError('phone-error')">

                                <div id="length-error-message" class="ms-1 mt-2" style="color:red; font-weight: 500;">
                                </div>

                                <div id="start-digit-error-message" class="ms-1 mt-2"
                                    style="color:red; font-weight: 500;"></div>
                            ...
                            <div class="form-group mb--20">
                                <textarea name="message" class="form-control" placeholder="Enter Your Message *"
                                    maxlength="500" cols="30" value="" rows="3"
                                    oninput="clearError('message-error')"></textarea>
                                <div id="message-error" class="ms-1 mt-2" style="color:red; font-weight: 500;"></div>
                            </div>
                            <div class="form-group mb--20">
                                <label id="ebcaptchatext"
                                    style="color:#bf0a30; font-weight:550; font-size:14px;padding-bottom:10px;"></label>
                                <input type="text" class="form-control" id="ebcaptchainput"
                                    oninput="captchaerror('captcha-error')">
                            ...
                            <input type="submit" name="submit" id="submit" value="Submit"
                                class="btn btn-black width-100 mb-20" style="pointer-events: all; cursor: pointer;"
                    ...
                    <div class="col-lg-6">
                        <div class="quick-contact-new">
                            ...
                            <img src="{{ asset('assets/img/contactus.png') }}" alt="" class="contactus-img">
                            ...
                            <ul class="quick-c-ul">
                                <li>
                                    ...
                                    <div>
                                        <a
                                            href="{{ isset($home->phone)?'tel:'.$home->phone : '#' }}">{{isset($home->phone)? $home->phone:'' }}</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="contact-inner-i">
                                    ...
                                    <div>
                                        <a
                                            href="{{ isset($home->email)?'mailto:'.$home->email : '#' }}">{{ isset($home->email)?$home->email : '' }}</a>
                                    </div>
                                </li>
                            </ul>
