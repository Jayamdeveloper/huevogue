...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Informative Pages /</span> <span> Cancellation & Refund Policy </span>
    </h4>

    <div class="app-ecommerce">
        <form action="{{ route('policies3.save') }}" method="POST">
            @csrf
            <!-- Add Product -->
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3 w-50">
                                ...
                                <input type="text" class="form-control" id="ecommerce-product-name" placeholder="Page Heading" value="{{isset($policy[2]->type)?$policy[2]->type:''}}" name="productTitle" aria-label="Product title">
                            </div>
                            ...
                            <div>
                                ...
                                <div class="form-control p-0 pt-1">
                                    ...
                                    <div class="comment-editor border-0 pb-4" id="product-description">
                                        {!! html_entity_decode(html_entity_decode($policy[2]->content)) !!}
                                    </div>
