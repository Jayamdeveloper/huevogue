    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="tab">
                ...
                <button class="tablinks" onclick="openCity(event, 'myProfileTab2')" id="defaultOpen">Order
                    History</button>
            </div>
        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row cart-con">
                            ...
                            <div class="col-xl-10 col-lg-7 col-md-8 col-8">
                                ...
                                <div>
                                    When using a beard serum, it's typically applied directly to the beard and massaged
                                ...
                                <div class="cart-bottom order-history-bottom">
                                    ...
                                    <div type="button" class="Track-order-btn btn btn-danger btn-sm"
                                        data-bs-toggle="modal" data-bs-target="#order-track">
                                        Track Order
